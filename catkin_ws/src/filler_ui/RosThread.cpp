...
double RosThread::getXSpeed(){ return m_speed; }
double RosThread::getASpeed(){ return m_angle; }

double RosThread::getXPos(){ return m_xPos; }
double RosThread::getYPos(){ return m_yPos; }
double RosThread::getAPos(){ return m_aPos; }
